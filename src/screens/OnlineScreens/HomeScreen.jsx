...
function HomeScreen() {
  ...
  return (
    ...
    <View className="flex-row items-center w-full  rounded-lg p-4">
      <View className="mt-2 w-20 h-20 flex justify-center items-center">
        <Text className="text-2xl  text-[#639067]">lu</Text>
        <Text className="text-2xl font-bold text-white bg-[#639067]  rounded-full w-12 h-12  items-center text-center">
          1
        </Text>
      </View>
      
  <Text className="text-xl border-4 border-gray-300 text-center rounded-full bg-gray-300 flex-1 mr-2 p-4 text-gray-600">
          Pas de repas prévu !
        </Text>
    </View>
  </View>
